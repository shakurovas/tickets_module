...
function AddFileInput()
{
	...
	table.innerHTML += '<label class="btn-style" for="file-0">Dateien auswählen</label><input name="FILE_'+counter+'" size="30" type="file" id="file-'+counter+'" /> <br />';
}

function AddFileInputNew()
{
	var counter = document.getElementById("files_counter").value;
	var table = document.getElementById("files_table_"+counter);
