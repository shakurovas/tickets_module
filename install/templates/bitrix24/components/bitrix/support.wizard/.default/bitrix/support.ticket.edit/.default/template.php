...
<table class="support-ticket-edit-form data-table">
    ...
    <?if(!empty($arResult["SECTION_DEP"]) && empty($arResult["TICKET"]["UF_TASK_FLAG"]) && ($arResult["ACSSES_GR"] == "Y")):?>
    <tr>
        <td class="field-name"><?=GetMessage("SUP_DEP")?>:</td>
        <td>
...
<?if((empty($arResult["TICKET"]["UF_TASK_FLAG"])) && ($arResult["ACSSES_GR"] == "Y")):?>
