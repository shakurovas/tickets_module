...
$MESS ['SUP_DEP'] = "Команда";

$MESS ["SUP_CR_TASK"] = "Создать задачу";
$MESS ["SUP_L_MESS"] = "Задача была создана из обращения. Ссылка на задачу";
$MESS ["SUP_L_MESS2"] = "Для получение информации о статусе задачи обратитесь в техническую поддержку.";
$MESS ["SUP_L_TASK"] = "Ссылка на обращение:";
?>